...
export default function Home() {
  ...
  const [Projectinfo, SetProjectinfo] = useState(["Name", "Des", "http://localhost:3001/"]);
  
  
  const [Project_Name] = useState(["SANDBLOCK แทนแกรมสร้างโลก", "Dream To Faculty", "COMSCI CHECK", "GUBGURU", "PIZZAPET"])
  const [Project_Details] = useState([`เป็นเกมที่สิ่งปลูกสร้าง ยานพาหนะ สิ่งมีชีวิต ถูกสร้างจาก Tangram Tangram คือ
          ...
          Multiplayerได้`, `เว็บแอปพิเคชันที่จะค้นหาคณะที่เหมาะกับตัวเองโดยใช้โมเดลพหุปัญญา เป็นการทำวิจัยเกี่ยวกับการจัดกลุ่มคณะ โดยแบ่งเป็น 5 กลุ่มในแต่ละกลุ่มจะนำจุดเด่น และ จุดด้อยของพหุปัญญาทั้ง 7 ด้านมาวิเคราะห์เป็นโมเดล  และ นำโมเดลไปใส่บนเว็บแอปพลิเคชัน`, `เว็บแอปพลิเคชัน ยืม/คืน อุปกรณ์ ของศูนย์วิทย์-คอม`, `เว็บแอปพลิเคชันจัดสรรงบประมาณโดยใช้ AI โดยจะจัดสรรการซื้อวัตถุดิบหรือสินค้าในการบริโภคสำหรับ 3 วัน โดยวัตถุดิบหรือสินค้าด้านการบริโภคจะเป็นวัตถุดิบที่มีอยู่ในชุมชนที่เราอาศัยอยู่โดยให้คนในชุมชนประกาศขายวัตถุดิบลงบนเว็บแอปพลิเคชันของเราเพื่อส่งเสริมให้คนในชุมชนมีรายได้มากขึ้นเพื่อทำให้ผู้ใช้งานมีสุขภาพที่ดีขึ้นและมีเงินเพียงพอในการใช้จ่ายต่างๆ ในชีวิตประจำวัน`, `แอปพลิเคชันช่วยลดการเล่นสมาร์ตโฟนโดยให้ผู้เข้าใช้งานนำเวลาที่ไม่ได้เล่นสมาร์ตโฟนนําไปทำกิจกรรมที่ต้องการ
...
const [Project_Link] = useState(["https://www.facebook.com/share/v/NyCS7ioLsyg1aSEN/", "http://app.sa.ac.th/dream-to-faculty/", "http://app.sa.ac.th/comsci_chi/", "http://app.sa.ac.th/gubguru/pages/", "http://os.sa.ac.th/comsci/detail.php?pid=87"])
      ...
      <div>
        ...
        <div className="flex flex-col gap-[20px] justify-center w-[80%] m-auto mt-[2cm]" >
          ...
          <section>
            ...
            <p>&emsp; My name is Pheemmapong Rodvaree, a 6th year student in the G-SciCom at Satri Angthong School. I started
              coding in 2020 and am interested in learning new technologies.</p>
          </section>

          <section>
            <h2 className='text-[24px] font-bold'>Education</h2>
            <p className='font-bold'>Satri Angthong School (2022-present)</p>
